 ...
 * @author Alan Fowler (Numerous changes to code and comments including use of
 *         BigDecimal)
...
public final class ShoppingFrame extends JFrame {
    ...
    /**
     * The map that stores each campus name and the campus's bookstore
     * inventory.
     */
     ...
     * @param theCurrentCampus The campus that is originally selected when the
     *            application starts.
     */
    ...
    private void setupGUI() {
        ...
        // make the GUI so that it cannot be resized by the user dragging a
        // corner
        setResizable(false);
    ...
    private JPanel makeCampusPanel() {
        ...
        for (final Object campus : myCampusInventories.keySet()) {
            ...
            rb.addActionListener(ae -> {
                ...
                // clear previous data from the ShppingCart and update the total
                // in the GUI
                myItems.clear();
                updateTotal();
