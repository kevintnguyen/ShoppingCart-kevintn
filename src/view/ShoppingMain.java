 ...
 * @author Alan Fowler (Numerous changes including use of BigDecimal and file
 *         input)
...
public final class ShoppingMain {
    ...
    public static void main(final String... theArgs) {
        ...
        for (final String campusName : campusNames) {
            ...
            // as defined in config.txt the campus with a * should be the "main"
            // campus
            ...
            CAMPUS_INVINTORIES.put(alteredName,
                                   FileLoader.readItemsFromFile(FILE_LOCATION
                                                                + alteredName.toLowerCase(Locale.ENGLISH)
                                                                + ".txt"));
        }
